...
console.log("\n## Model-family hint\n");
{
	...
	const kimiCwd = buildAlgorithmContext("e3", "moonshotai/kimi-k2.6", "/home/lars/Developer/pi-mono");
	...
	check("Notice has cwd anchoring rule", kimi.includes("CWD anchoring"));
	check("Notice has filename disambiguation rule", kimi.includes("filename disambiguation"));
	check("Cwd embedded when provided", kimiCwd.includes("/home/lars/Developer/pi-mono"));
