...
export default function todosExtension(pi: ExtensionAPI) {
	...
	pi.registerTool({
		...
		renderResult(result, { expanded, isPartial }, theme) {
			...
			// For actions with a todo property (get, create, update, append, delete, claim, release)
	...
	pi.registerCommand("todos", {
		...
		handler: async (args, ctx) => {
			...
			if (nextPrompt) {
				...
				// Type assertion needed because TS narrows captured variable in async closure
