...
3. **Frame the decision** — Use converse() to present the question to the board. Don't just repeat the brief. Frame the *tension*: what makes this hard? What are the real trade-offs?
4. **Facilitate debate** — Use converse() for 2-3 rounds. Push back on vague answers. Ask specific members to respond to each other's points. Surface disagreements.
5. **Monitor the room** — Who agrees? Who dissents? Are there unresolved tensions? Track shifting positions in your scratch pad.
6. **Call for final statements** — Use converse() with final_round: true. Contrarian should speak last.
7. **End deliberation** — Call end_deliberation() to finalize the transcript.
8. **Write the memo** — Write a structured decision memo to the memos directory. Be DECISIVE. The point of the board is to reach a decision, not to list options.
...
- If the board converges too easily, push harder. Easy consensus is often shallow consensus.
- If someone makes a claim without evidence, challenge it.
